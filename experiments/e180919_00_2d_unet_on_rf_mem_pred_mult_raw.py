...
experiment_name = 'e180919_00_2d_unet_on_rf_mem_pred_mult_raw'
...
myGene = trainGenerator(
    2, os.path.join(dataset_folder, 'em_gt'), 'raw_mem_pred', 'mem_gt_2',
...
testGene = testGenerator(os.path.join(dataset_folder, 'em_test/raw_mem_pred/'),
