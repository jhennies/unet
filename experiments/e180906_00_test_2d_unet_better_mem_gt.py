...
experiment_name = 'e180906_00_test_2d_unet_better_mem_gt'
...
#     2, os.path.join(dataset_folder, 'em_gt'), 'raw', 'mem_gt_2',
...
testGene = testGenerator(os.path.join(dataset_folder, 'em_test/raw/'), num_image=64, target_size=(512, 512))
model = unet(input_size=(512, 512, 1))
